...
contract ApartidaorioNFT is ERC721Enumerable, Ownable {
  ...
  function eventDateTime(uint256 _tokenId) public view returns (string memory) {
    
    return  _politicalEvents[_tokenId].date;
  }

  function eventLocation(uint256 _tokenId) public view return
  ...
  function setPoliticalEvent(uint256 tokenId, 
                            ...
                            string memory location) public onlyOwner {
    ...
    p_event = PoliticalEvent(source_name, source_url, event_description,statement,author,datetime, location);
